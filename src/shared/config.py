...
REVISION_CRITERION_FLOORS: dict[str, float] = json.loads(
    env("REVISION_CRITERION_FLOORS", '{"accuracy": 8.0, "completeness": 7.0, "readability": 7.0, "seo": 6.0}')
)
...
ESPN_TEAMS = [
    ...
    {"name": "Chicago Stars FC", "sport": "soccer", "league": "usa.nwsl", "team_id": 15360},
]
...
CREDIBLE_SOURCES = [
    "ESPN", "MLB.com", "NBA.com", "NHL.com", "Chicago Tribune",
    "Chicago Sun-Times", "Bleacher Report", "The Athletic",
    "CBS Sports", "NBC Sports", "Sports Illustrated", "Yahoo Sports",
    "Associated Press",
]

CONTENT_SIGNAL_KEYWORDS = [
    "recap", "score", "highlights", "final", "win", "loss",
    "game", "match", "result", "victory", "defeat",
]

# --- Static config: Teams (from sources.yaml) ---
TEAMS = [
    {"name": "Chicago Bulls", "sport": "basketball", "league": "NBA", "keywords": ["bulls", "chicago bulls", "nba chicago"]},
    {"name": "Chicago Bears", "sport": "football", "league": "NFL", "keywords": ["bears", "chicago bears", "nfl chicago"]},
    {"name": "Chicago Cubs", "sport": "baseball", "league": "MLB", "keywords": ["cubs", "chicago cubs", "mlb chicago", "wrigley"]},
    {"name": "Chicago White Sox", "sport": "baseball", "league": "MLB", "keywords": ["white sox", "chicago white sox", "sox", "guaranteed rate"]},
    {"name": "Chicago Blackhawks", "sport": "hockey", "league": "NHL", "keywords": ["blackhawks", "chicago blackhawks", "hawks", "nhl chicago"]},
    {"name": "Chicago Fire", "sport": "soccer", "league": "MLS", "keywords": ["fire", "chicago fire", "mls chicago"]},
    {"name": "Chicago Sky", "sport": "basketball", "league": "WNBA", "keywords": ["sky", "chicago sky", "wnba chicago"]},
    {"name": "Chicago Stars", "sport": "soccer", "league": "NWSL", "keywords": ["stars", "chicago stars", "nwsl chicago"]},
    {"name": "Chicago Hounds", "sport": "rugby", "league": "MLR", "keywords": ["hounds", "chicago hounds", "mlr chicago"]},
]
