...
def handler(event, context):
    """Deduplicate articles by fuzzy title matching."""
    ...
    if not new_articles:
        memory.save_checkpoint(
            ...
            {'unique_articles': [], 'duplicate_count': 0},
        )
    ...
    for _team, articles in by_team.items():
        ...
        for article in sorted_articles:
            ...
            for _, accepted_title in accepted:
                if (
                    fuzz.token_sort_ratio(title_lower, accepted_title)
