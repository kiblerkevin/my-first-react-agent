...
def main():
    ...
    parser.add_argument("--db", default="data/articles.db", help="Path to SQLite database")
    parser.add_argument("--output", default="data/export", help="Output directory for JSON files")
